...
export class SetStmt implements CommandStmt {
  ...
  /**
   * Checks if the variable needs to be declared.
   * @returns True if the variable needs to be declared, false otherwise.
   */
  need_declare(): boolean {
    return this.need_declare_;
  }
}
