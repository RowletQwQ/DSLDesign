    ...
    next(input: ScriptInputEvent): ResultEvent {
        if (this.is_global_) {
            if (this.need_declare_) {
                ...
                this.upper_context_.assign_global_symbol(this.id_, this.value_expr_.get_value(this.upper_context_));
            }
        } else {
            if (this.need_declare_) {
                this.upper_context_.set_local_symbol(this.id_, this.value_expr_.get_value(this.upper_context_));
            } else {
                this.upper_context_.assign_local_symbol(this.id_, this.value_expr_.get_value(this.upper_context_));
            }
        }
